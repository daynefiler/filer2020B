...
To move NBS into the \replaced{fetal}{neonatal} period we must develop noninvasive methodologies agnostic to paternity.
\added{Having prenatal genetic diagnoses will allow for optimized care in the immediate newborn period and the further development of \emph{in utero} therapies.}
