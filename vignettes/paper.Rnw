...
<<>>=
l <- list(list(path = "fig-genoHist-1.pdf", width = 0.33),
          list(path = "fig-genoHist-2.pdf", width = 0.33),
          list(path = "fig-genoHist-3.pdf", width = 0.33, newline = TRUE),
          list(path = "fig-genoLgnd-1.pdf", width = 1, newline = TRUE))
...
<<>>=
l <- list(list(path = "fig-f34FragLen-1.pdf", width = 0.5),
          list(path = "fig-f34FragLen-2.pdf", width = 0.5, newline = TRUE),
          list(path = "fig-fragLgnd-1.pdf", width = 1, newline = TRUE))
stitchPlots(figLst = l,
            width = 6.76,
            height = 2.65,
            figname = "figure2.pdf")
...
<<>>=
l <- list(list(path = "fig-pmarBySratio-1.pdf", width = 0.33),
          list(path = "fig-pmarBySratio-2.pdf", width = 0.33),
          list(path = "fig-pmarBySratio-3.pdf", width = 0.33, newline = TRUE))
stitchPlots(figLst = l,
            width = 6.75,
            height = 2.25,
            figname = "figure3.pdf")
...
<<>>=
l <- list(list(path = "fig-binDist-1.pdf", width = 0.5),
          list(path = "fig-binDist-2.pdf", width = 0.5, newline = TRUE),
          list(path = "fig-genoLgnd-1.pdf", width = 1, newline = TRUE))
stitchPlots(figLst = l,
            width = 6.76,
            height = 2.9,
